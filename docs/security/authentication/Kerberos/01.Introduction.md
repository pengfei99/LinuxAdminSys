...
Used by services and automated scripts to authenticate to Kerberos.

Contains one or more encryption keys linked to a Kerberos principal.
...
It supports many algorithms to fits different hardware and OS requirements. Below are some
